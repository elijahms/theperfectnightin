    ...
    return (
            <div>
                ...
                <Button.Group widths='5'>
                    ...
                    {sucClick === true && <Card style={{fontSize: "10pt"}}> <Image style={{maxHeight: "200px", width: "100%"}}  src={imageDisplay2} />
                    <Card.Content>
                        <Card.Header style={{minHeight: "25px"}} >{titleDisplay2}</Card.Header>
